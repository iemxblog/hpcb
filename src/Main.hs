      ...
      layer FCu $
        footprint "R1" $
          translate (V2 0 0.127) $
            ...
            <> translate (V2 3.81 0) (pad 1 ThroughHole Circle (V2 1.397 1.397) 0.812799 (Net 1 "/SIGNAL"))
            <> translate (V2 3.81 0) (pad 1 ThroughHole Circle (V2 1.397 1.397) 0.812799 (Net 2 "GND"))
